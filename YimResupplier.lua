...
if tonumber(online_version:get_string()) == 3095 then
...
elseif tonumber(online_version:get_string()) < 3095 then
    gui.show_message("YimResupplier", "Update your game before playing GTA Online!")
    yim_resupplier = gui.get_tab("YimResupplier")
    yim_resupplier:add_text("Update your game before playing GTA Online!")
...
else gui.show_message("YimResupplier", "Failed to load!")
end
